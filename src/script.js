...
window.location.href = 'anuncio.html'; // Redireciona para a página de funções de anúncio
...
window.location.href = 'perfil.html'; // Redireciona para login.html
...
{ term: "Genérico", section: "Autos", page: "autos.html?q=" },

{ term: "Genérico", section: "Ferramentas", page: "ferramentas.html?q=" },

{ term: "Genérico", section: "Imóveis", page: "imoveis.html?q=" },

{ term: "Genérico", section: "Esportes", page: "esportes.html?q=" },

{ term: "Genérico", section: "Decorações de Festa", page: "decoracoes.html?q=" },
...
/* Endereçamento do restante dos botões do header */
    ...
    if (planoProfissionalButton) {
        planoProfissionalButton.addEventListener('click', (event) => {
            ...
            window.location.href = 'plano-profissional.html'; // Redireciona para profissional.html
        });
    ...
    if (meusAnunciosButton) {
        meusAnunciosButton.addEventListener('click', (event) => {
            event.stopPropagation();
            window.location.href = 'perfil.html'; // Redireciona para anuncio.html
        });
    ...
    if (chatButton) {
        chatButton.addEventListener('click', (event) => {
            event.stopPropagation();
            window.location.href = 'chat.html'; // Redireciona para chat.html
        });
    ...
    if (notificacoesButton) {
        notificacoesButton.addEventListener('click', (event) => {
            event.stopPropagation();
            window.location.href = 'notificacoes.html'; // Redireciona para notificacoes.html
        });
